...
Next.js 15 standalone dashboard. Same code serves the local launch (`localhost:4040` via `onemem dashboard`) and is wrapped by `apps/hosted-dashboard/` for `app.onemem.ai`.
