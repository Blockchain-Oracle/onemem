...
Gives each Hermes agent session decentralized memory stored on MemWal. Install
into a Hermes profile at ``$HERMES_HOME/plugins/onemem/`` and activate with
``memory.provider: onemem`` in config.yaml.
